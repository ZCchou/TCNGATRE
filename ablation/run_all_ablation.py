...
def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(
        description="Run all TCNGATRE ablation variants across one or more datasets."
    )
    parser.add_argument(
        "--python",
    ...
    parser.add_argument(
        ...
        choices=MODEL_ORDER,
        default=MODEL_ORDER,
        help="Subset of ablation models to run.",
    )
    parser.add_argument(
        "--datasets",
        nargs="+",
    ...
    parser.add_argument(
        "--log-root",
        default=str(ABLATION_ROOT / "batch_logs"),
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"[BATCH] ablation_root={ABLATION_ROOT}")
